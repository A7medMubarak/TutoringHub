        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationDetails = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Centers_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassGroups_Centers_CenterId",
                        column: x => x.CenterId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Centers_TeacherId",
                table: "Centers",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassGroups_CenterId",
                table: "ClassGroups",
                column: "CenterId");
